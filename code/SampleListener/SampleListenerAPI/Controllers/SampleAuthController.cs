...
namespace SimpleTools.SimpleHooks.SampleListener.SampleListenerAPI.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class SampleAuthController(SampleDbContext contextDb, IConfiguration configuration) : ControllerBase
    {
        ...
        [HttpPost]
        [Authorize(Policy = "RequireSample")]
        ...
        {
            return Ok("auth api is running successfully");
        }
